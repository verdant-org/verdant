          ...
          <div className="flex w-full">
            ...
            <div className="flex flex-col items-center gap-4 max-w-lg w-full p-4 bg-stone-100 dark:bg-stone-900 h-[52rem] overflow-y-scroll no-scrollbar">
              ...
              <div className="flex flex-col gap-4 w-full items-start my-4">
                ...
                <Select onValueChange={(value) => {setLegend(value as LegendMapProps)}} defaultValue="Risk Index">
                  <SelectTrigger className="w-[200px]">
                    <SelectValue placeholder="Theme"/>
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="Risk Index">Risk Index</SelectItem>
                    <SelectItem value="Expected Annual Loss">Expected Annual Loss</SelectItem>
                    <SelectItem value="Community Resilience">Community Resilience</SelectItem>
                    <SelectItem value="Social Vulnerability">Social Vulnerability</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              {countyData && isAvailable && (
                <div className="flex flex-col gap-4 w-full items-start">
                  ...
                  <div className="flex flex-col items-start gap-4 w-full">
                    ...
                    <div className="text-base">{countyData.stateName}, United States</div>
                  </div>

                  <div className="border-b-2 w-full pb-4 flex flex-col gap-4">
                    <div className="font-bold text-2xl">Change Hazard Information</div>
                    <Select
