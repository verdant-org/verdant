          ...
          <div className="bg-muted rounded-lg p-8 flex items-center justify-center">
            <div className="relative w-full aspect-square max-w-md">
              <div className="absolute inset-0 flex items-center justify-center">
                <Image src="/verdant_logo.png" alt="Verdant Logo" width={300} height={300} className="rounded-lg bg-transparent" />
              </div>
      ...
      <section className="py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" className="gap-2">
            <SignedIn>
              <Link href="/dashboard">Explore the Dashboard</Link> <Leaf className="w-5 h-5" />
              </SignedIn>
              <SignedOut>
              <Link href="/login">Explore the Dashboard</Link> <Leaf className="w-5 h-5" />
              </SignedOut>
          </Button>
